...
import static com.apprikart.rotationmatrixdemo.location.LocationUtils.isBetterLocation;
...
class MapboxFusedLocationEngineImpl extends AndroidLocationEngineImpl {
  ...
  @SuppressLint("MissingPermission")
  @Override
  public void requestLocationUpdates(@NotNull @NonNull LocationEngineRequest request,
                                     @NotNull @NonNull PendingIntent pendingIntent) throws SecurityException {
