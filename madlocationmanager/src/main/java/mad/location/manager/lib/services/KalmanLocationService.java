...
public class KalmanLocationService extends Service
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            case Sensor.TYPE_LINEAR_ACCELERATION:
                Log.d("kalmanLocationService", "Checking the Flow -- Type Linear Acceleration");
                ...
                if (m_kalmanFilter == null) {
                    Log.d("kalmanLocationService", "Checking the Flow -- If KalmanFilter is null");
                    break;
                }
            ...
            case Sensor.TYPE_ROTATION_VECTOR:
                Log.d("kalmanLocationService", "Checking the Flow -- Type Rotation Vector");
    ...
    public void onLocationChanged(Location loc) {
        ...
        GeomagneticField f = new GeomagneticField(
                ...
                timeStamp);
        // f.getDeclination() will give The declination of the horizontal component of the magnetic field from true north, in degrees
